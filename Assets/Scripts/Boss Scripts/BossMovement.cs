...
public class BossMovement : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform[] movementPosition;
    ...
    void GetRandomMevementPosition()
    {
        int randomIndex = Random.Range(0, movementPosition.Length);

        while(targetPosition == movementPosition[randomIndex].position)
        {
             randomIndex = Random.Range(0, movementPosition.Length);
        }

        targetPosition = movementPosition[randomIndex].position;
